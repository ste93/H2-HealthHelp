...
public class TopicPublisher {
     ...
     * @param hostPort - the port of the host of the message broker server.
     */
    public TopicPublisher(String exchangeName, String hostIP, int hostPort) {
        this.exchangeName = exchangeName;
        //System.out.println("connecting to : " + hostIP +":"+ hostPort);
        this.factory = new ConnectionFactory();
        this.factory.setHost(hostIP);
        this.factory.setPort(hostPort);
        // N.B. : this depend on the host setting
    ...
    private void mqttSetup() {
        ...
        try {
            ...
            channel.exchangeDeclare(this.exchangeName, BuiltinExchangeType.TOPIC, false);
        } catch (IOException e) {
